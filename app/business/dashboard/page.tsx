...
export default function BusinessDashboardPage() {
  ...
  if (!business) return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-3 md:px-4 lg:px-5 text-center">
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                  ...
                                  <div className="space-y-3 lg:col-span-2">
                                    ...
                                    <input type="number" value={serviceForm.metadata?.minGroupSize || 1} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, minGroupSize: parseInt(e.target.value) || 1 } })} className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                  <div className="space-y-3 lg:col-span-2">
                                    <label className="text-[9px] font-black tracking-[0.3em] uppercase text-foreground/40 ml-4">Max Group Size</label>
                                    <input type="number" value={serviceForm.metadata?.maxGroupSize || 10} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, maxGroupSize: parseInt(e.target.value) || 10 } })} className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  <div className="space-y-3">
                                    ...
                                    <input value={serviceForm.metadata?.accommodationType || ""} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, accommodationType: e.target.value } })} placeholder="Budget, mid-range, luxury" className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                  <div className="space-y-3">
                                    <label className="text-[9px] font-black tracking-[0.3em] uppercase text-foreground/40 ml-4">Room Specs & Amenities</label>
                                    <input value={serviceForm.metadata?.accommodationAmenities || ""} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, accommodationAmenities: e.target.value } })} placeholder="Shared/Private, WiFi..." className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                  <div className="space-y-3">
                                    <label className="text-[9px] font-black tracking-[0.3em] uppercase text-foreground/40 ml-4">Transport Protocol</label>
                                    <input value={serviceForm.metadata?.transportType || ""} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, transportType: e.target.value } })} placeholder="Minibus, SUV, Flight..." className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                  <div className="space-y-3">
                                    <label className="text-[9px] font-black tracking-[0.3em] uppercase text-foreground/40 ml-4">Transport Condition</label>
                                    <input value={serviceForm.metadata?.transportCondition || ""} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, transportCondition: e.target.value } })} placeholder="AC, comfort level" className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    <input value={serviceForm.metadata?.requiredDocuments || ""} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, requiredDocuments: e.target.value } })} placeholder="Passport, Visa..." className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                  <div className="space-y-3 md:col-span-2">
                                    <label className="text-[9px] font-black tracking-[0.3em] uppercase text-foreground/40 ml-4">Emergency Contact & Safety</label>
                                    <input value={serviceForm.metadata?.emergencyContact || ""} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, emergencyContact: e.target.value } })} placeholder="Emergency numbers, guide qualifications" className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    <input value={serviceForm.metadata?.uniqueExperiences || ""} onChange={e => setServiceForm({ ...serviceForm, metadata: { ...serviceForm.metadata, uniqueExperiences: e.target.value } })} placeholder="Unique experiences, bonuses" className="w-full bg-white px-3 md:px-4 lg:px-5 py-4 rounded-3xl border border-foreground/5 font-bold text-sm outline-none focus:ring-8 focus:ring-primary/5 transition-all focus:border-primary/20" />
                                  </div>
                                </div>
                              </div>
                      ...
                      <div className="grid grid-cols-1 gap-12">
                        {categoryRequestForm.categories.includes("hotel") && (
                          <div className="space-y-6 pt-4 border-t border-foreground/[0.03]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <input name="website" type="text" placeholder="Institutional Website" onChange={handleRequestIndustryChange} className="w-full px-8 py-5 bg-white border border-foreground/[0.05] rounded-[24px] text-sm font-bold outline-none focus:ring-8 focus:ring-primary/5" />
                              <div className="md:col-span-2 space-y-4">
                                ...
                                <div className="relative group">
                                  <input name="hotelLicense" id="hotelLicense" type="file" onChange={handleRequestFileChange} className="hidden" accept=".pdf,image/*" />
                        ...
                        {categoryRequestForm.categories.includes("tour_operator") && (
                          <div className="space-y-6 pt-6 border-t border-foreground/[0.03]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <input name="languages" type="text" placeholder="Global Languages Supported" onChange={handleRequestIndustryChange} className="w-full px-8 py-5 bg-white border border-foreground/[0.05] rounded-[24px] text-sm font-bold outline-none focus:ring-8 focus:ring-primary/5" />
                              <input name="specialization" type="text" placeholder="Expedition Archetype Focus" onChange={handleRequestIndustryChange} className="w-full px-8 py-5 bg-white border border-foreground/[0.05] rounded-[24px] text-sm font-bold outline-none focus:ring-8 focus:ring-primary/5" />
                              <div className="md:col-span-2 space-y-4">
                                ...
                                <div className="relative group">
                                  <input name="tourCert" id="tourCert" type="file" onChange={handleRequestFileChange} className="hidden" accept=".pdf,image/*" />
                        ...
                        {categoryRequestForm.categories.includes("car_rental") && (
                          <div className="space-y-6 pt-6 border-t border-foreground/[0.03]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <input name="fleetSize" type="number" placeholder="Fleet Density (Artifact Count)" onChange={handleRequestIndustryChange} className="w-full px-8 py-5 bg-white border border-foreground/[0.05] rounded-[24px] text-sm font-bold outline-none focus:ring-8 focus:ring-primary/5" />
                              <input name="vehicleTypes" type="text" placeholder="Vehicle Archetypes (e.g. 4x4, Luxury)" onChange={handleRequestIndustryChange} className="w-full px-8 py-5 bg-white border border-foreground/[0.05] rounded-[24px] text-sm font-bold outline-none focus:ring-8 focus:ring-primary/5" />
                              <div className="md:col-span-2 space-y-4">
                                ...
                                <div className="relative group">
                                  <input name="carRentalLicense" id="carRentalLicense" type="file" onChange={handleRequestFileChange} className="hidden" accept=".pdf,image/*" />
                        ...
                        {categoryRequestForm.categories.includes("event_organizer") && (
                          <div className="space-y-6 pt-6 border-t border-foreground/[0.03]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <input name="experienceYears" type="number" placeholder="Operational Experience (Years)" onChange={handleRequestIndustryChange} className="w-full px-8 py-5 bg-white border border-foreground/[0.05] rounded-[24px] text-sm font-bold outline-none focus:ring-8 focus:ring-primary/5" />
                              <input name="eventType" type="text" placeholder="Primary Event Specialization" onChange={handleRequestIndustryChange} className="w-full px-8 py-5 bg-white border border-foreground/[0.05] rounded-[24px] text-sm font-bold outline-none focus:ring-8 focus:ring-primary/5" />
                              <div className="md:col-span-2 space-y-4">
                                ...
                                <div className="relative group">
                                  <input name="eventCert" id="eventCert" type="file" onChange={handleRequestFileChange} className="hidden" accept=".pdf,image/*" />
